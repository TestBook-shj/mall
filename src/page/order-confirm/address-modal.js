 ...
 * @Last Modified time: 2019-01-10 23:10:34
 */
'use strict';
...
var addressModal = {
  ...
  bindEvent: function() {
    ...
    this.$modalWrap.find('.address-btn').click(function() {
      ...
      // 更新收件人， 并且验证通过 
        ...
        _address.uodate(receiverInfo.data, function(res) {
  ...
  loadProvince: function() {
    ...
    if (this.option.isUpdate && this.option.data.receiverProvice) {
      $provinceSelect.val(this.option.data.receiverProvice)
      // 加载城市
      this.loadCities(this.option.data.receiverProvice);
    }
  },
  // 加载城市信息
  ...
  getReceiverInfo: function() {
    ...
    if (this.option.isUpdate) {
      receiverInfo.id = this.$modalWrap.find('#receiver-receiver-id').val();
    }
    // 表单验证
